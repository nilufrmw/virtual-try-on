...
A minimal Virtual Try-On web application. It takes an upper-body photo of a person and an image of a garment, then uses the open-source IDM-VTON model hosted on Hugging Face to generate an image of the person wearing that garment.
